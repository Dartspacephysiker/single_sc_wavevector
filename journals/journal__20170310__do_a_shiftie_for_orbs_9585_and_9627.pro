...
;JOURNAL__20170310__DO_A_SHIFTIE_FOR_ORBS_9585_AND_9627,/SAVE_PS,/USE_DB_FAC,/PUBLICATION_SETTINGS,ORBIT=9585,/LOCK_FWDSHIFT_TO_BACKSHIFT,KP__ANGLERANGE=[0,360],PAGE1__FREQRANGE=[0,6],PAGE2__FREQRANGE=[0,6],/NOSHIFT,/PLOT_POSFREQ,/FOOTBALL_LAYOUT,/FOOTBALL_YLOG,/FOOTBALL_COL2TITLE,MARK_KS_BELOW_BOTH=[0.2,20],/ITVL_MODE,INTERVAL=0,/FOOTBALL_KMAG,CUSTOM_ADDSEC=0.0
     ...
     CASE orbit OF
        9585: BEGIN
           ...
           CASE 1 OF
              ...
              END
              interval EQ 3: BEGIN
                 custom_t1 = '1999-01-23/14:50:30.0'
