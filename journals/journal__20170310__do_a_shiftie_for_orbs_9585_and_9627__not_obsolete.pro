;2017/03/10
;Wow, a time consumer:
;JOURNAL__20170310__DO_A_SHIFTIE_FOR_ORBS_9585_AND_9627__NOT_OBSOLETE,/SAVE_PS,/USE_DB_FAC,/PUBLICATION_SETTINGS,ORBIT=9585,date='20170310',/PLOT_SMOOTHED_K_COMPONENTS,/LOCK_FWDSHIFT_TO_BACKSHIFT,CUSTOM_T1='1999-01-23/14:50:55',CUSTOM_T2='1999-01-23/14:51:07',KX_SPECIALFREQS=[[0.9,2],[3.6,4.4]],/MAKE_KX_VS_KY_SPECIAL,KX_SPECIALBOUNDS=[-3.0,-0.5],/MAKE_KPANGLE_SPECIAL
;
;WINNER #1:
;JOURNAL__20170310__DO_A_SHIFTIE_FOR_ORBS_9585_AND_9627__NOT_OBSOLETE,/SAVE_PS,/USE_DB_FAC,/PUBLICATION_SETTINGS,ORBIT=9627,/PLOT_SMOOTHED_K_COMPONENTS,/LOCK_FWDSHIFT_TO_BACKSHIFT,KP__ANGLERANGE=[-45,315]
;
;WINNER #2:
;JOURNAL__20170310__DO_A_SHIFTIE_FOR_ORBS_9585_AND_9627__NOT_OBSOLETE,/SAVE_PS,/USE_DB_FAC,/PUBLICATION_SETTINGS,ORBIT=10832,date='20170310',/PLOT_SMOOTHED_K_COMPONENTS,/LOCK_FWDSHIFT_TO_BACKSHIFT,KP__ANGLERANGE=[-120,240]
